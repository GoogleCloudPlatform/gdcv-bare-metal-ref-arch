...
grep -q "export ASM_VERSION_POINT=[${VALID_CHARACTERS}]\+$" ${ENVIRONMENT_FILE} || echo -e "export ASM_VERSION_POINT=${ASM_VERSION_POINT:-0}" >> ${ENVIRONMENT_FILE}
grep -q "export ASM_VERSION_REV=[${VALID_CHARACTERS}]\+$" ${ENVIRONMENT_FILE} || echo -e "export ASM_VERSION_REV=${ASM_VERSION_REV:-4}" >> ${ENVIRONMENT_FILE}
...
grep -q "export BMCTL_VERSION=[${VALID_CHARACTERS}]\+$" ${ENVIRONMENT_FILE} || echo -e "export BMCTL_VERSION=${BMCTL_VERSION:-1.10.0}" >> ${ENVIRONMENT_FILE}
...
grep -q "export CLOUD_SDK_VERSION=[${VALID_CHARACTERS}]\+$" ${ENVIRONMENT_FILE} || echo -e "export CLOUD_SDK_VERSION=${CLOUD_SDK_VERSION:-365.0.1}" >> ${ENVIRONMENT_FILE}
